...
from webapp.views import index, pong_game, games, register, user_profile, save_game_result, game_stats, pong_tour, pong_tour2, pong_game2, pong_AI, pong_AI2, set_language
